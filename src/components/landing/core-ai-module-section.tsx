              ...
              <div className="border-b border-[#32374366] px-6 py-5">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <button
                    ...
                    className="rounded-md p-2 text-[#bdc1ca] hover:bg-black/20 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
                    onClick={() => setIsAnalyticsModalOpen(false)}
                  >
                    <X className="size-5" />
                  </button>
              ...
              <div className="border-b border-[#32374366] p-6">
                ...
                <div className="mt-4 flex items-center justify-between gap-3">
                  <button
                    ...
                    className="rounded-md border border-[#323743] bg-black px-3 py-2 text-sm hover:bg-black/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
                  >
                  ...
                  <div className="flex items-center gap-2">
                    {analyticsSlides.map((slide, idx) => (
                      <button
                        ...
                        className={`h-2.5 rounded-full transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 ${
                          activeSlide === idx
                            ? "w-6 bg-cyan-500"
                            : "w-2.5 bg-white/50"
                        }`}
                ...
                <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-4">
                  {analyticsSlides.map((slide, idx) => (
                    <button
                      ...
                      key={slide.src}
                      onClick={() => setActiveSlide(idx)}
                      className={`overflow-hidden rounded-md border focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 ${
                        activeSlide === idx
